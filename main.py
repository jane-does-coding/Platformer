...
class Obstacle(pygame.sprite.Sprite):
	def __init__(self,type):
		...
		if type == 'fly':
			...
			snail = pygame.image.load('graphics/snail/Snail.png').convert_alpha()
			snail = pygame.transform.scale(snail, (60, 50))  # width, height in pixels
			self.frames = [snail]
			y_pos = 300
...
def draw_panel(surface, rect, color, radius):
...
while True:
	...
	if game_active:
		...
		screen.blit(sky_surface, (0, 0))
		screen.blit(ground_surface, (0, 300))
		panel_rect = pygame.Rect(180, 50, 440, 320)
		draw_panel(screen, panel_rect, (255, 255, 255, 230), 20)
